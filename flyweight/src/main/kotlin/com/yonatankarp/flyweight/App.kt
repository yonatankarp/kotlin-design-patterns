 ...
 *
 * In this example [AlchemistShop] has great amount of potions on its
 * shelves. To fill the shelves [AlchemistShop] uses [PotionFactory]
 * (which represents the Flyweight in this example). Internally
 * [PotionFactory] holds a map of the potions and lazily creates new ones
 * when requested.
 *
